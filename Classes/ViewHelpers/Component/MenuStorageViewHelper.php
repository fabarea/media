...
class MenuStorageViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
	...
	public function render() {
		...
		$template = '<form action="/typo3/mod.php" id="form-menu-storage" method="get">
						%s
						<select name="%s[storage]" id="menu-storage" class="btn btn-mini" style="height: 18px" onchange="$(\'#form-menu-storage\').submit()">%s</select>
					</form>';
