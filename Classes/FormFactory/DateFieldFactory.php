 ...
 */
class DateFieldFactory extends \TYPO3\CMS\Media\FormFactory\FieldFactory {

	/**
	 * Get a text field object
	 *
	 * @throws \TYPO3\CMS\Media\Exception\EmptyPropertyException
	 * @return \TYPO3\CMS\Media\Form\DateField
	 */
	public function get() {
		...
		/** @var $fieldObject \TYPO3\CMS\Media\Form\DateField */
		$fieldObject = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\CMS\Media\Form\DateField');
		...
		$value = $dateViewHelper->render('@' . $this->value, $format);
