...
/**
 * Repository for accessing Video
 */
class VideoRepository extends \TYPO3\CMS\Media\Domain\Repository\AssetRepository {

	/**
	 * @var string
	 */
	protected $objectType = 'TYPO3\CMS\Media\Domain\Model\Video';

	/**
	 * Returns all Video of this repository.
	 *
	...
	public function findBy(\TYPO3\CMS\Media\QueryElement\Matcher $matcher, \TYPO3\CMS\Media\QueryElement\Order $order = NULL, $limit = NULL, $offset = NULL) {
		$matcher->addMatch('type', \TYPO3\CMS\Core\Resource\File::FILETYPE_VIDEO);
