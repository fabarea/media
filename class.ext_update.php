...
class ext_update  {
	...
	function main()	{
		...
		if (!\TYPO3\CMS\Core\Utility\GeneralUtility::_GP('do_update'))	{
			$onClick = "document.location.href='".\TYPO3\CMS\Core\Utility\GeneralUtility::linkThisScript(array('do_update'=>1))."'; return false;";
	...
	function access()	{
		...
		if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('4.1')) {
