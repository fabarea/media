...
/**
 * Test case for class \TYPO3\CMS\Media\Form\TextArea.
 *
 * @author Fabien Udriot <fabien.udriot@typo3.org>
 * @package TYPO3
 * @subpackage media
 */
class TextAreaTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \TYPO3\CMS\Media\Form\TextArea
	 */
	private $fixture;
	...
	public function setUp() {
		$this->fixture = new \TYPO3\CMS\Media\Form\TextArea();
	 ...
	 * @test
	 */
	public function renderTextAreaWithRandomNameContainsInputString() {
		$actual = $this->fixture->setName($this->fakeName)->render();
		$this->assertContains('<textarea', $actual);
	}
}
?>