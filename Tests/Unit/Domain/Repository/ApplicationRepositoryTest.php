...
class ApplicationRepositoryTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	public function findByReturnsSameNumberOfRecordsAsNumberOfFakeRecords() {
		...
		$this->assertEquals($this->numberOfFakeApplications, count($this->fixture->findBy($matcher)));
	}
	...
	public function countByReturnsSameNumberOfRecordsAsNumberOfFakeRecords() {
		$matcher = new \TYPO3\CMS\Media\QueryElement\Matcher();
		$matcher->addMatch('tx_phpunit_is_dummy_record', '1');
		$this->assertEquals($this->numberOfFakeApplications, $this->fixture->countBy($matcher));
	}
