...
/**
 * Test case for class \TYPO3\CMS\Media\Tca\TableService.
 *
...
class TableServiceTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \TYPO3\CMS\Media\Tca\TableService
	 */
	private $fixture;
	...
	public function setUp() {
		$tableName = 'sys_file';
		$serviceType = 'table';
		$this->fixture = new \TYPO3\CMS\Media\Tca\TableService($tableName, $serviceType);
	}
